...
import {
  ...
  Plugin,
  checkAvailability,
} from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { FileTransfer, FileUploadOptions, FileTransferObject } from '@ischemaview-awesome-cordova-plugins/file-transfer/ngx';
 * import { File } from '@ischemaview-awesome-cordova-plugins/file';
 *
