...
import { AwesomeCordovaNativePlugin, Cordova, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 *   import { HyperTrack } from '@ischemaview-awesome-cordova-plugins/hyper-track';
 *
