...
import { CordovaProperty, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { WebView } from '@ischemaview-awesome-cordova-plugins/ionic-webview/ngx';
 *
 *
