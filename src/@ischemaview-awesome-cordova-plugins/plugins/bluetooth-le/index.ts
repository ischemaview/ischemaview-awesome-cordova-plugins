...
import { AwesomeCordovaNativePlugin, Cordova, CordovaProperty, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { BluetoothLE } from '@ischemaview-awesome-cordova-plugins/bluetooth-le/ngx';
 *
 *
