import { Cordova, CordovaOptions, AwesomeCordovaNativePlugin, Plugin, wrap } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { PhotoLibrary } from '@ischemaview-awesome-cordova-plugins/photo-library/ngx';
 *
