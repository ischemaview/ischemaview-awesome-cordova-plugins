...
import { Plugin, CordovaInstance, AwesomeCordovaNativePlugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { BackgroundUpload } from '@ischemaview-awesome-cordova-plugins/background-upload/ngx';
 *
 *
