...
import { Cordova, CordovaFunctionOverride, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * ```typescript
 * import { ThreeDeeTouch, ThreeDeeTouchQuickAction, ThreeDeeTouchForceTouch } from '@ischemaview-awesome-cordova-plugins/three-dee-touch/ngx';
 *
