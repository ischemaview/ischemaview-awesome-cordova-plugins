 ...
 * @usage
 * ```typescript
 * import { CameraPreview, CameraPreviewPictureOptions, CameraPreviewOptions, CameraPreviewDimensions } from '@ischemaview-awesome-cordova-plugins/camera-preview/ngx';
 *
