...
import { Plugin, Cordova, AwesomeCordovaNativePlugin, getPromise } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { WonderPush } from '@ischemaview-awesome-cordova-plugins/wonderpush';
 *
 *
