...
import { CordovaCheck, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { AbbyyRTR } from '@ischemaview-awesome-cordova-plugins/abbyy-rtr/ngx';
 *
 *
