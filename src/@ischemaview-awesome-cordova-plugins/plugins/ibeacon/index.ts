...
import { Cordova, CordovaCheck, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 *
 * ```typescript
 * import { IBeacon } from '@ischemaview-awesome-cordova-plugins/ibeacon/ngx';
 *
...
@Injectable()
export class IBeacon extends AwesomeCordovaNativePlugin {
  /**
