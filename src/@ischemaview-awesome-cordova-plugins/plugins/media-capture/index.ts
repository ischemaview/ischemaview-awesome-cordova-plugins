...
import { Cordova, CordovaProperty, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { MediaCapture, MediaFile, CaptureError, CaptureImageOptions } from '@ischemaview-awesome-cordova-plugins/media-capture/ngx';
 *
 *
