...
import { Plugin, Cordova, CordovaProperty, AwesomeCordovaNativePlugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { Pollfish } from '@ischemaview-awesome-cordova-plugins/pollfish/ngx';
 *
 *
