...
import { Plugin, CordovaProperty, AwesomeCordovaNativePlugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```
 * import { BuildInfo } from '@ischemaview-awesome-cordova-plugins/build-info/ngx';
 *
