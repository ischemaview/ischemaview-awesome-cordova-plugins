...
import { Cordova, AwesomeCordovaNativePlugin, CordovaProperty, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { Keyboard } from '@ischemaview-awesome-cordova-plugins/keyboard/ngx';
 *
