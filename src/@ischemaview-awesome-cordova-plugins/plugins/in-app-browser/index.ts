...
import { CordovaInstance, InstanceCheck, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { InAppBrowser } from '@ischemaview-awesome-cordova-plugins/in-app-browser/ngx';
 *
