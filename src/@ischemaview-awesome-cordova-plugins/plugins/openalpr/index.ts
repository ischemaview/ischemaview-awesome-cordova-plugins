...
import { Cordova, AwesomeCordovaNativePlugin, Plugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { OpenALPR, OpenALPROptions, OpenALPRResult } from '@ischemaview-awesome-cordova-plugins/openalpr/ngx';
 *
 *
 ...
 * }
 *
 * // To get imageData, you can use the @ischemaview-awesome-cordova-plugins/camera module for example. It works with DestinationType.FILE_URI and DATA_URL
 *
