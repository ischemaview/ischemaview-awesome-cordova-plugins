...
import { Plugin, Cordova, AwesomeCordovaNativePlugin } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { UnviredCordovaSDK } from '@ischemaview-awesome-cordova-plugins/unvired-cordova-sdk/ngx';
 *
 *
...
@Plugin({
  ...
  install: 'ionic cordova plugin add @ischemaview-awesome-cordova-plugins/unvired-cordova-sdk', // OPTIONAL install command, in case the plugin requires variables
