...
import { Cordova, CordovaCheck, AwesomeCordovaNativePlugin, Plugin, getPromise } from '@ischemaview-awesome-cordova-plugins/core';
 ...
 * @usage
 * ```typescript
 * import { EmailComposer } from '@ischemaview-awesome-cordova-plugins/email-composer/ngx';
 *
