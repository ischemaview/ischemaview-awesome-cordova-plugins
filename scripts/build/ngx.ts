...
export function transpileNgxCore() {
  getProgram([resolve(ROOT, 'src/@ischemaview-awesome-cordova-plugins/core/index.ts')]).emit({
...
export function generateLegacyBundles() {
  [
    resolve(ROOT, 'dist/@ischemaview-awesome-cordova-plugins/core/index.js'),
    ...
    rollup({
      ...
      external: ['@angular/core', '@ischemaview-awesome-cordova-plugins/core', 'rxjs', 'tslib'],
    }).then((bundle) =>
      bundle.write({
